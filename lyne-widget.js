(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent =
      ...
      '#lyne-orb-toggle .flame-glow{position:absolute;inset:8px;border-radius:16px;box-shadow:0 0 28px rgba(59,130,246,.42);animation:lyneGlow 2.1s ease-in-out infinite}' +
